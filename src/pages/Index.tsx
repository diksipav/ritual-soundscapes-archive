...
const Index = () => {
  ...
  const CustomPlayButton = () => <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center transform group-hover:scale-110 transition-all duration-500 shadow-xl border border-white/20">
  ...
  return <div ref={containerRef} className="min-h-screen bg-background">
      ...
      duration: 1
        ...
        <VideoHero isLive={false} videoUrl="https://www.youtube.com/watch?v=rxAe3xqyeSA" className="h-screen">
          <motion.div initial={{
          opacity: 0,
          y: 40
        }} animate={{
          ...
          delay: 0.5
            ...
            {/* Centered Logo */}
            <motion.div className="mb-12 sm:mb-16 flex justify-center" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            <motion.h2 className="text-3xl sm:text-5xl md:text-7xl text-white mb-6 sm:mb-8 tracking-wider leading-tight" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            <motion.p className="font-body text-base sm:text-lg md:text-xl text-white/90 mb-8 sm:mb-12 leading-relaxed tracking-wide px-4" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            <motion.div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center px-4" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            delay: 1.3
              ...
              <Link to="/shop">
                <motion.button className="btn-animated-primary tracking-widest w-full sm:w-auto" whileHover={{
                scale: 1.05,
                y: -2
              }} whileTap={{
                scale: 0.98
              ...
              <Link to="/archive">
                <motion.button className="btn-animated-ghost tracking-widest text-white border-white hover:bg-white hover:text-foreground w-full sm:w-auto" whileHover={{
                scale: 1.05,
                y: -2
              }} whileTap={{
                scale: 0.98
      ...
      <motion.section className="min-h-screen py-16 sm:py-32 px-4 sm:px-6 flex items-center" initial="hidden" whileInView="visible" viewport={{
      once: true,
      amount: 0.3
    }} variants={staggerContainer}>
        <div className="max-w-7xl mx-auto w-full">
          <motion.div className="text-center mb-12 sm:mb-20" variants={fadeInUpVariants}>
            <motion.h2 className="font-display text-4xl sm:text-5xl md:text-7xl text-foreground mb-6 sm:mb-8 tracking-wider" whileHover={{
            ...
            <motion.p className="font-body text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed tracking-wide px-4" variants={fadeInUpVariants}>
              DISCOVER OUR LATEST SESSIONS PERFORMED BY RÖVE, EACH CRAFTED TO TRANSPORT YOU TO A DIFFERENT STATE OF CONSCIOUSNESS
            </motion.p>
          </motion.div>

          <motion.div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 sm:gap-8 lg:gap-12" variants={staggerContainer}>
            ...
            duration: 0.3
                ...
                <Link to={`/video/${session.id}`} className="group block">
                  <div className="card-elegant overflow-hidden relative">
                    <motion.div className="aspect-video overflow-hidden rounded-sm mb-4 sm:mb-6 relative" whileHover={{
                  scale: 1.02
                }} transition={{
                  duration: 0.4
                }}>
      ...
      amount: 0.3
        ...
        <div className="max-w-5xl mx-auto w-full">
          <motion.div className="text-center mb-12 sm:mb-20" variants={fadeInUpVariants}>
            <motion.h2 className="text-4xl sm:text-5xl md:text-7xl text-foreground mb-6 sm:mb-8 tracking-wider" variants={fadeInUpVariants} style={{
            fontFamily: '"Playfair Display", serif'
          }}>
              UPCOMING EVENTS
            </motion.h2>
            <motion.p className="font-body text-base sm:text-lg text-muted-foreground tracking-wide px-4" variants={fadeInUpVariants}>
      ...
      {/* Philosophy Section */}
      <motion.section className="min-h-screen bg-muted/10 py-16 sm:py-32 px-4 sm:px-6 flex items-center" initial="hidden" whileInView="visible" viewport={{
      once: true,
      amount: 0.3
    }} variants={staggerContainer}>
        <div className="max-w-5xl mx-auto text-center w-full">
          <motion.h2 className="text-4xl sm:text-5xl md:text-7xl text-foreground mb-8 sm:mb-12 tracking-wider" variants={fadeInUpVariants} style={{
          fontFamily: '"Crimson Text", serif'
        }}>
            OUR PHILOSOPHY
          </motion.h2>
          <motion.p className="font-body text-base sm:text-xl text-muted-foreground leading-relaxed mb-8 sm:mb-12 tracking-wide px-4" variants={fadeInUpVariants}>
